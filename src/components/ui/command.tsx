...
function CommandDialog({ title = "Search", description = "Search across the platform", children, ...props }: CommandDialogProps) {
  return (
    <Dialog {...props}>
...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex cursor-pointer select-none items-center gap-2.5 rounded-md text-sm outline-none",
